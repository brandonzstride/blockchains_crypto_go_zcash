...
extern "C" {
#endif
SWIGINTERN const char *_wrap_My_variable_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_double((double)(My_variable));
  if (value) {
...
SWIGINTERN const char *_wrap_My_variable_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN int
_wrap_fact(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:fact n ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_my_mod(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:my_mod x y ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
SWIGINTERN int
_wrap_get_time(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":get_time ") == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "fact", (swig_wrapper_func) _wrap_fact, NULL},
    { SWIG_prefix "my_mod", (swig_wrapper_func) _wrap_my_mod, NULL},
    { SWIG_prefix "get_time", (swig_wrapper_func) _wrap_get_time, NULL},
    {0, 0, 0}
};

static swig_var_info swig_variables[] = {
    { SWIG_prefix "My_variable", 0, (swig_variable_func) _wrap_My_variable_get,(swig_variable_func) _wrap_My_variable_set},
    {0,0,0,0}
};
...
SWIGEXPORT int Example_SafeInit(Tcl_Interp *interp) {
